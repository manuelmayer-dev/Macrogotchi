...
`src/Macrogotchi/` is deliberately minimal: one integration and one example action,
...
```bash
macrodeck-plugin test --project src/Macrogotchi --report markdown --output conformance.md
```
